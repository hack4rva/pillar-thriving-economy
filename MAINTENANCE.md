...
**Thriving Economy Pillar Research Corpus**
...
Pattern: `[SECTION][NUMBER]_[topic_slug].[md|json]`

Example: `A6_problem_landscape_permitting.md`
...
```json
{
  "id": "A6_problem_landscape_permitting",
  "section": "A",
  "title": "Problem Landscape: Permitting Friction",
...
### Step 5 — Update `research/README.md`

Add a row to the appropriate section table:

```markdown
| [A6_problem_landscape_permitting](./A6_problem_landscape_permitting.md) | Permitting friction points for small businesses |
```
...
```json
{
  "id": "research/A6_problem_landscape_permitting",
  "path": "research/A6_problem_landscape_permitting.md",
  "type": "research_report",
  "title": "Problem Landscape: Permitting Friction",
  "pillar": "thriving-economy",
  "section": "A",
  "summary": "One to two sentence grounded summary.",
  "tags": ["permitting", "small business", "friction"],
  "recommended_audience": ["teams exploring setup navigator", "teams researching regulatory barriers"],
  "read_after": ["research/A2_problem_landscape_small_business_journey.md"],
...
- Is the research/README.md table row accurate?
...
3. If you updated a verified claim, check whether `_admin/evidence_log.md` needs a corresponding update.
...
2. Update every reference (README.md, index.json, manifest.json, AGENTS.md, any skill files, any report frontmatter with `related_reports`)
3. Rename the file
...
`_admin/evidence_log.md` tracks verified factual claims.
...
1. List all `.md` files in `research/` (excluding README.md)
...
| File | What to check |
|------|--------------|
| `research/README.md` | All sections have rows for existing files |
...
[ ] research/README.md tables include new files
...
| `nav_file` | `README.md`, `research/README.md` | Navigation only | No |
...
| `evidence_log` | `_admin/evidence_log.md` | Verified claims | Yes |
